  ...
  <header class="bg-white dark:bg-black">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12 ">
        ...
        <a href="./products.php" class="text-sm font-semibold leading-6  text-blue-500">Products</a>
        ...
        <a href="./login.html" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">Log in <span
    ...
    <div class="lg:hidden hidden dark:bg-black" role="dialog" aria-modal="true" id="menu">
      ...
      <div
        class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 dark:bg-black">
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10 dark:divide-white">
            <div class="space-y-2 py-6">
              <a href="./index.html"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:text-white">Home</a>
              <a href="./products.php"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-blue-500 hover:bg-gray-50 dark:text-blue-900">Products</a>
              <a href="./about.html"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:text-white">About</a>
              <a href="./contact.html"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:text-white">Contact</a>
            </div>
            <div class="py-6 dark:divide-blue-500/10 divide-y dark:divide-white">
              <a href="#"
                class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:text-white">Log
                in</a>
            </div>
  ...
  <div class="main">
    <div class="bg-gradient-to-r from-white to-blue-200 lg:p-24 dark:from-black dark:to-blue-500">
        <div id="content" class="p-20 justify-center justify-items-center">
          <h1 class="lg:text-6xl pd-3 text-4xl dark:text-white">Products</h1>
          <a class="text-8 pt-4 dark:text-white">Choose from a very wide range of products...
          </a>
        </div>
      </div>
    <div class="grid grid-rows-1 bg-gray-300 p-20 lg:p-24 justify-items-center dark:bg-black">
      <div class="pb-10">
        <h1 class="lg:text-6xl capitalize text-4xl text-blue-500 dark:text-white">INDIAN CUISINE</h1>
      </div>
      <div class="flex flex-row gap-4 scroll-pl-5 snap-x sm:flex-col" id="newproducts">
        <?php
// Include the database connection file
require_once './php/db.php';

// Retrieve new products from the database
$query = "SELECT * FROM products WHERE pnew = true";
$result = mysqli_query($conn, $query);

// Check if the query was successful
if ($result) {
  // Display the new products in a card format
  while ($row = mysqli_fetch_assoc($result)) {
    echo '<div class="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">';
    echo '<a href="#">';
    echo '<img class="rounded-t-lg p-8 h-100px" src="./assets/images/indian-cuisine/' . $row['pimage'] . '" alt="product image">';
    echo '</a>';
    echo '<div class="px-5 pb-5">';
    echo '<a href="#">';
    echo '<h3 class="text-gray-900 font-semibold text-xl tracking-tight dark:text-white">' . $row['pname'] . ', ' . $row['pcusine'] . '</h3>';
    echo '</a>';
    echo '<div class="flex items-center mt-2.5 mb-5">';
    echo '<span class="text-sm font-medium text-gray-900 dark:text-white">' . $row['pimagealt'] . '</span>';
    echo '</div>';
    echo '<div class="flex items-center justify-between">';
    echo '<span class="text-3xl font-bold text-gray-900 dark:text-white">$' . $row['prate'] . '</span>';
    echo '<a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
  }
    ...
    <div class="items-center flex flex-coloum flex-nowrap justify-between content-end sm:flex-row">
      ...
      <div class="p-5 justify-between flex flex-coloum flex-nowrap dark:text-white dark:fill-white">
        ...
        <a class="z-20">
          ...
          <svg style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" version="1.1"
            viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
            xmlns:serif="http://www.serif.com/" xmlns:xlink="http://www.w3.org/1999/xlink" class="w-11 dark:fill-white">
            <path
        ...
        <a>
          ...
          <svg enable-background="new 0 0 56.693 56.693" viewBox="0 0 56.693 56.693" width="56.693px"
            xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            class="w-11 dark:fill-white">
            <path
        ...
        <a>
          ...
          <svg style="enable-background:new 0 0 67 67;" fill="#000000" viewBox="0 0 67 67" xml:space="preserve"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="w-11 dark:fill-white">
            <path
